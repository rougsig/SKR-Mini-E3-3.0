...
#define STRING_CONFIG_H_AUTHOR "(Rhaqbany)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME ">>>>>>> Rhaqbany SKR Mini E3 3.0<<<<<<<"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 700 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -64, +4, -3.55 }
